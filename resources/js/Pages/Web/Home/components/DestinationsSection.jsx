...
import {ArrowBack, ArrowForward, ExpandMore, PhotoLibraryOutlined, Star, Person} from '@mui/icons-material';
                        ...
                        {destinations.map((destination) => (
                            ...
                            >
                                <div className="relative h-52 w-full overflow-hidden sm:h-56">
                                    <img
                                        src={destination.home_image || destination.grid_image || destination.banner_image || '/images/placeholder-destination.jpg'}
                                    ...
                                    <div
                                        className="absolute right-4 top-4 flex items-center gap-1 rounded-full border border-white/10 bg-black/40 px-2.5 py-1 backdrop-blur-md">
                                    ...
                                    {destination.featured_specialist && (
                                        <div className="absolute -bottom-7 left-4">
                                            <div
                                                className="h-14 w-14 overflow-hidden rounded-2xl border-[3px] border-white bg-gray-200 shadow-lg">
                                                {destination.featured_specialist.profile_pic ? (
                                                    ...
                                                    <div
                                                        className="flex h-full w-full items-center justify-center bg-[#3260FE]/10">
                                ...
                                <div
                                    className={`flex flex-1 flex-col px-4 pb-4 sm:px-5 ${destination.featured_specialist ? 'pt-10' : 'pt-5'}`}>
                                    <div className="mb-4 flex items-start justify-between gap-4">
                                        <div>
                                            {destination.featured_specialist ? (
                                                <>
                                                    <h4 className="mb-1 text-[17px] font-bold">
                                                ...
                                                <>
                                                    <h4 className="mb-1 text-[17px] font-bold">{destination.name}</h4>
                                                    <p className="text-[8px] font-bold uppercase tracking-[0.16em] text-[#3f484a]">
                                        ...
                                        <Link
                                            ...
                                            aria-label={`View ${destination.name} gallery`}
                                        >
                                    ...
                                    <div
                                        className="mt-auto flex flex-col items-start gap-3 border-t border-[#bec8ca]/30 pt-4 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
