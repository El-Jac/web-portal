...
const Index = () => (
    <WebsiteLayout>
        <Head>
            ...
            <link
                href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@9..144,600;700;800&family=Inter:wght@400;500;600;700&family=Manrope:wght@400;500;600;700;800&family=Raleway:ital,wght@1,400;1,500;1,600;1,700&display=swap"
                rel="stylesheet"
            />
        </Head>
        <WhoWeAreHeader />
